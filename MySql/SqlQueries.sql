...
create table cart(CartId char(36) primary key default(UUID()),UserId char(36) null,ProductId char(36) NULL,foreign key (UserId) references  Users(UserId) on delete set null, foreign key (ProductId) references Products(ProductId) on delete set null ) ;
